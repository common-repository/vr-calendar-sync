...
namespace VRCICS_ICal; // Renamed to avoid plugin conflicts
...
class ICal
{
    ...
    /**
     * Tracks the number of status in the current iCal feed
     *
     * @var string
     */
    public $linesStatus = "";
    ...
    /**
     * Tracks the number of filename in the current iCal feed
     *
     * @var string
     */
    public $linesFilename = "";
    ...
    protected function initLines(array $lines)
    {
        ...
        $this->linesStatus = $lines["status"];
        
        $this->linesFilename = $lines["filename"];
    ...
    protected function fileOrUrl($filename)
    {
        ...
        if (($lines = file($filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES, $context)) === false) {
            ...
            return array("status"=>"false", "filename"=>$filename);
        }
